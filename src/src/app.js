...
function APPsaussure() {
  ...
  this.texts = {
    ...
    pp1617g: [
      {
        rif: "Deuxième cours de linguistique générale. Godel cfs 15 pp. 16-17",
        re: "not available",
        p:
    ...
    pp3233g: [
      {
        rif: "Deuxième cours de linguistique générale. Godel cfs 15 pp. 32-33",
        re: "not available",
        p:
    ...
    pp47g: [
      {
        rif: "Deuxième cours de linguistique générale. Godel cfs 15 pp. 47",
        re: "not available",
        p:
        ...
        e: "not available",
        themes: "Linguistique interne / Linguistique Externe"
      }
    ],
    pp48g: [
      {
        rif: "Deuxième cours de linguistique générale. Godel cfs 15 pp. 48",
        re: "not available",
        p:
    ...
    pp92g: [
      {
        rif: "Deuxième cours de linguistique générale. Godel cfs 15 pp. 92",
        re: "not available",
        p:
        ...
        e: "not available",
        themes: "Synchronie/diachronie"
      }
    ],
    ff135: [
      {
        rif:
          "Science du langage. Essence double. BGE AdS 372/4 ff. 135 ≈ ELG 67 ≈ Amacker 2011 p. 125",
        re: "Science du langage. Essence double",
        p:
    ...
    f1v: [
      {
        rif:
          "Science du langage. Status et motus. BGE MS fr. 3951/12 f. 1v ≈ ELG 225 ≈ CLG/E 3299",
        re: "Status et motus.",
        p:
    ...
    ff0911: [
      {
        rif:
          "Science du langage. Notes Whitney. BGE MS fr. 3951/10 ff. 9-11 ≈ ELG 206-208 ≈ CLG/E 3297",
        re: "Notes Whitney.",
        p:
    ...
    ff3233: [
      {
        rif:
          "Science du langage. Notes Whitney. BGE MS fr. 3951/10 ff. 32-33 ≈ ELG 216-217 ≈ CLG/E 3297",
        re: "Notes Whitney.",
        p:
  ...
  this.showSimilarTexts = function (themes, id) {
    console.log("in showSimilarTexts", themes);
    var simbox = document.getElementById("simbox");
    let t = [];

    Object.entries(this.texts).forEach(([key, value]) => {
      //console.log(`${key}:`, value);
      let tm = value[0].themes || "";
      let r = key;
      if (tm !== "" && tm === themes && r !== id) t.push(key);
    });
    console.log("array texts", t);
    simbox.children[1].children[1].textContent = "themes: ".concat(themes);
    t.forEach((k) => {
      let text = this.texts[k][0];
      console.log(text);

      simbox.children[1].innerHTML += `<br /><br /><a href="testi.html?rif=${k}">${text.rif}</a>`;
    });
